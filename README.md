# Notebooks, files, and programs from "Python intro"

This repo contains the Jupyter notebook + program files from my training for O'Reilly on October 28th, 2024.  It'll remain open, so you can review the material later on.
